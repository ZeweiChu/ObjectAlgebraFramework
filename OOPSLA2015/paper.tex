...
\authorinfo{Haoyuan Zhang \and Jason Chu \and Bruno~C.~d.~S.~Oliveira}
           {The University of Hong Kong}
           {\{hyzhang,bruno\}@cs.hku.hk}
...
\hl{Year of ref~\cite{bruno12oa} fixed.}

\hl{Name of ref~\cite{nordberg96variations} fixed.}

\hl{Ref~\cite{Hannemann:2002:DPI:582419.582436} added.}
