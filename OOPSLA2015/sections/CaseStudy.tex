...
\subsection{\Name vs Vanilla Regarding Code Size}
...
\textbf{AST based implementation}  & 661  \\\bottomrule
  \end{tabular}
  \caption{Source Lines of Code (SLOC) statistics: \Name implementation vs Vanilla AST implementation}\label{TBL:sloc}
\end{table}
...
10 + 15 + 58 + 30 + 35 + 10 + 27 + 48 = 233


503 for control deps, type env, inline conds, rename
todo: data deps, desugar unless, desugar repeat.
\end{comment}
