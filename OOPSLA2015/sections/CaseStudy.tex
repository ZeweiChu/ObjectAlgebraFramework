...
before~\cite{gouseti14extensible}.  QL is similar MiniQL, except that
...
In the context of QL, ``unless'' desugaring, condition inlining and variable renaming can be chained together as follows:
  ...
  \lstinputlisting[linerange=161-163]{../QL/src/_syb/trafo/TestPipelining.java} % APPLY:linerange=PIPELINEQL
...
The algebra \lstinline{alg} can now be used to create questionnaires:
  ...
  \lstinputlisting[linerange=167-170]{../QL/src/_syb/trafo/TestPipelining.java} % APPLY:linerange=PIPELINEQL_CALL
