...
In the context of QL, ``unless'' desugaring, condition inlining and variable renaming can be chained together as follows:
  ...
  \lstinputlisting[linerange=133-135]{../QL/src/_syb/trafo/TestPipelining.java} % APPLY:linerange=PIPELINEQL
...
The algebra \lstinline{alg} can now be used to create questionnaires:
  ...
  \lstinputlisting[linerange=139-142]{../QL/src/_syb/trafo/TestPipelining.java} % APPLY:linerange=PIPELINEQL_CALL
