...
\begin{figure}[htbp]
\nocaptionrule
\lstinputlisting[linerange=10-87]{../ObjectAlgebras/src/example_QLAlg1/QL.java} % APPLY:linerange=OO_APPROACH
...
\lstinputlisting[linerange=10-36]{../ObjectAlgebras/src/example_QLAlg2/UsedVars.java} % APPLY:linerange=QL_QUERY_ALG
