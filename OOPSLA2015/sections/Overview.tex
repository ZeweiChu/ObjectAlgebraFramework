...
For instance, the renaming operation mentioned above could be realized as follows:

\lstinputlisting[linerange=36-49]{../ObjectAlgebras/src/example_QLAlg2/Rename.java} % APPLY:linerange=QL_TRANSFORM_ALG_SIMP
