...
\haoyuan{More code, e.g., generated code for mini-QL example.}
\subsubsection{OO Approach for \lstinline{usedVars} and \lstinline{rename}}
...
\subsubsection{\lstinline{SetMonoid} in Fig.~\ref{ql_with_oaframework}}
