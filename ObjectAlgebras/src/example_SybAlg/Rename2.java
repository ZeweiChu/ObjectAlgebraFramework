...
public class Rename2 implements G_SybAlgTransform<String, String, String, String, String, String, String> {
	...
	public Function<String, String> D(String name, Function<String, String> manager, List<Function<String, String>> subUnits) {
		return acc -> alg.D(name, manager.apply(name), substListSybAlg(subUnits, name));
	}
