...
public class StmTest {
	...
	public static void main(String[] args){
		...
		StringQueryStmAlgebra stringQuery = new StringQueryStmAlgebra(new StringMonoid());
		StmRename renaming = new StmRename(stringQuery);
		System.out.println(exp(stringQuery));
		System.out.println(exp(renaming));
