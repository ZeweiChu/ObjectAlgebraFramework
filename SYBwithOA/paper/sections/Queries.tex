...
\begin{figure}[tb]
\lstinputlisting[linerange=4-18]{../src/expDemo3/FreeVarsMonoid.java} % APPLY:linerange=FREEVARS_MONOID
\vspace{-.1in}
...
\begin{figure}[tb]
\lstinputlisting[linerange=4-24]{../src/expDemo3/QueryExpAlg.java} % APPLY:linerange=GENERIC_QUERY
\vspace{-.1in}
...
Free Vars Query
\begin{figure}[tb]
\lstinputlisting[linerange=4-7]{../src/expDemo3/FreeVarsQueryExpAlg.java} % APPLY:linerange=FREEVARS_QUERY
\vspace{-.1in}
