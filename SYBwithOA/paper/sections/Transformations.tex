...
\begin{figure}[tb]
\lstinputlisting[linerange=4-32]{../src/expDemo3/ExpAlgTransform.java} % APPLY:linerange=GENERIC_TRANSFORM
\vspace{-.1in}
...
\begin{figure}[tb]
\lstinputlisting[linerange=4-22]{../src/expDemo3/SubstVarsTransform.java} % APPLY:linerange=SUBSTVARS_TRANSFORM
\vspace{-.1in}
