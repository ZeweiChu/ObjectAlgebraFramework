...
static types it is easy to distinguish between different kinds of
...
kinds of nodes, having to explicitly write code for each kind of node is both tedious and error-pone.
