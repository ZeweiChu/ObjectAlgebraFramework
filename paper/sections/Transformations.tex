...
\begin{figure}[!htbp]
\lstinputlisting[linerange=4-10]{../ObjectAlgebras/src/expDemo2/SubstVarExpAlg.java} % APPLY:linerange=SUBSTVARS_WITHOUT_ID
\vspace{-.1in}
...
\begin{figure}[t]
\lstinputlisting[linerange=4-7]{../ObjectAlgebras/src/expDemo3/SubstVarExpAlg.java} % APPLY:linerange=SUBSTVARS_WITH_ID
\vspace{-.1in}
