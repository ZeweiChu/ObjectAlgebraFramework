...
Figure~\ref{trafoTemplate} shows the general template for \lstinline{Alg<X1, X2, ..., Xn>}. Here \lstinline{Alg}$_T$ extends \lstinline{Alg} with the same sorts. And the base algebra \lstinline{alg()} is declared inside.
