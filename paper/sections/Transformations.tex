...
\begin{figure}[!htbp]
\lstinputlisting[linerange=3-16]{../ObjectAlgebras/src/expDemo2/SubstVarsExpAlg.java} % APPLY:linerange=SUBSTVARS_WITHOUT_ID
\vspace{-.1in}
...
\begin{figure}[!htbp]
\lstinputlisting[linerange=3-9]{../ObjectAlgebras/src/expDemo3/SubstVarsExpAlg.java} % APPLY:linerange=SUBSTVARS_WITH_ID
\vspace{-.1in}
