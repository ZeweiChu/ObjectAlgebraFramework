...
The result of constructing this simple questionnaire is a formatting object representing the questionnaire after desugaring, inlining and renaming:
...
As can be seen, the ``unless'' statement has been desugard.
