...
\begin{figure}[!htbp]
\lstinputlisting[linerange=-]{} % APPLY:linerange=EXP_ALG
\vspace{-.1in}
...
\begin{figure}[tb]
\lstinputlisting[linerange=-]{} % APPLY:linerange=FREEVARS_WITHOUT_MONOID
\vspace{-.1in}
...
\begin{figure}[tb]
\lstinputlisting[linerange=-]{} % APPLY:linerange=MONOID
\vspace{-.1in}
...
\begin{figure}[tb]
\lstinputlisting[linerange=-]{} % APPLY:linerange=GENERIC_QUERY
\vspace{-.1in}
...
\begin{figure}[tb]
\lstinputlisting[linerange=-]{} % APPLY:linerange=FREEVARS_MONOID
\vspace{-.1in}
...
\begin{figure}[tb]
\lstinputlisting[linerange=-]{} % APPLY:linerange=FREEVARS_WITH_MONOID
\vspace{-.1in}
