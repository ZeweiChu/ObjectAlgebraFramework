...
\begin{figure}[tb]
\lstinputlisting[linerange=8-20]{../ObjectAlgebras/src/expDemo2/FreeVarsExpAlg.java} % APPLY:linerange=FREEVARS_WITHOUT_MONOID
\vspace{-.1in}
...
\begin{figure}[tb]
\lstinputlisting[linerange=6-16]{../ObjectAlgebras/src/expDemo3/Monoid.java} % APPLY:linerange=MONOID
\vspace{-.1in}
