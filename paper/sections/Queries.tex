...
\begin{figure}[!htbp]
\lstinputlisting[linerange=6-16]{../Library/src/library/Monoid.java} % APPLY:linerange=MONOID
\vspace{-.1in}
...
\begin{figure}[tb]
\lstinputlisting[linerange=3-21]{../ObjectAlgebras/src/expDemo3/QueryExpAlg.java} % APPLY:linerange=GENERIC_QUERY
\vspace{-.1in}
...
\begin{figure}[tb]
\lstinputlisting[linerange=3-21]{../ObjectAlgebras/src/expDemo3/FreeVarsMonoid.java} % APPLY:linerange=FREEVARS_MONOID
\vspace{-.1in}
...
\begin{figure}[!htbp]
\lstinputlisting[linerange=3-6]{../ObjectAlgebras/src/expDemo3/FreeVarsQueryExpAlg.java} % APPLY:linerange=FREEVARS_QUERY
\vspace{-.1in}
